...
$(function(){
			...
			$('#test').datagrid({
				...
				nowrap: false,
				striped: true,
				url:'DataPage/getDatas.jsp?&p=stuinfo&p=6@2@15@5',
				sortName: 'p0',
				sortOrder: 'desc',
				idField:'p0',
				frozenColumns:[[
	                {field:'ck',checkbox:true},
	                {field:'p0',title:'学员卡号',width:pw*0.25},
					{field:'p1',title:'学员姓名',width:pw*0.25},
					{field:'p2',title:'性别',width:pw*0.25},
					{field:'p3',title:'生日',width:pw*0.25}
				]],
				pagination:true,
				rownumbers:true,
				singleSelect:true,
...
<div id="form1" region="north" title="生日提醒" split="true"
...
<table id="tb1" border="1" width="100%" height="30">
	...
	href="javascript:void(0)">查询</a>&nbsp;&nbsp;&nbsp;
		<a class="easyui-linkbutton" id="exportXLS" icon="icon-print"
