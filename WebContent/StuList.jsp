...
$(function(){
			...
			if(s != "管理员"){
				...
				url:'DataPage/getDatasBysite.jsp?&p=stuinfo&q=6@2@15@7@8@9@10&r=StuSite&s='+site,
				sortName: 'p0',
				sortOrder: 'desc',
				idField:'p0',
				frozenColumns:[[
			...
			$('#test').datagrid({
				...
				nowrap: false,
				striped: true,
				url:'DataPage/getDatas.jsp?&p=stuinfo&p=6@2@15@7@8@9@10@4@1',
				sortName: 'p0',
				sortOrder: 'desc',
				idField:'p0',
				frozenColumns:[[
...
<div id="form1" region="north" title="学员列表" split="true"
...
<form name="delrecord" method="post" action="FunctionPage/delRecord.jsp"
	...
	<input type="hidden" name="deltablename" value="stuinfo" />
	<input type="hidden" name="delreturnpage" value="StuList.jsp" />
	</form>
</div>
