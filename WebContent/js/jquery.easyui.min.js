...
},beforePageText:"当前页",afterPageText:"/总共 {pages} 页",displayMsg:"显示 {from} 到 {to} 条记录/总共 {total} 条记录"};
})(jQuery);
(function($){
function _23a(node){
node.each(function(){
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"不能为空.",invalidMessage:null,rules:{email:{validator:function(_326){
