...
<table width="100%" border="0">
	<tr valign="top">
		...
		<td align="center"><img src="theme/img/sys_setting1.gif" /></td>
	...
	<tr valign="middle" height="32px">
		...
		<td align="center" id="Module7"><a href="#"
			onclick="select('系统设置',7)" class="link1" onmouseover="mouseover(7)"
			onmouseout="mouseout(7)">系统设置</a></td>
...
<table width="60%" border="0" style="padding: 0px; margin: 0px">
	<tr valign="middle">
		<td class="natd"><img src="theme/img/member_card_setting_ico.gif" /></td>
		<td id="sz_1"><a class="link1" href="#"
			onmouseover="sz_mouseover(1)" onmouseout="sz_mouseout(1)"
			onclick="checkrole('CardOption.jsp')">学员卡设置</a></td>
	</tr>
	<tr valign="middle">
		<td class="natd"><img src="theme/img/subbranch_setting_ico.gif" /></td>
		<td id="sz_2"><a class="link1" href="#"
			onmouseover="sz_mouseover(2)" onmouseout="sz_mouseout(2)"
			onclick="checkrole('CourseOption.jsp')">课程设置</a></td>
	</tr>
	<tr valign="middle">
		<td class="natd"><img src="theme/img/member_case_statis_ico.gif" /></td>
		<td id="sz_3"><a class="link1" href="#"
			onmouseover="sz_mouseover(3)" onmouseout="sz_mouseout(3)"
			onclick="checkrole('SiteOption.jsp')">教学点设置</a></td>
	</tr>
	<tr valign="middle">
		<td class="natd"><img src="theme/img/user_manage_ico.gif" /></td>
		<td id="sz_4"><a class="link1" href="#"
			onmouseover="sz_mouseover(4)" onmouseout="sz_mouseout(4)"
			onclick="checkrole('UserOption.jsp')">用户设置</a></td>
	</tr>
</table>
</div>
</div>
