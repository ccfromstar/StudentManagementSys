...
$(function(){
			...
			checkuserAction(info,'学员旷课','学员旷课');
			...
			$('#test').datagrid({
				...
				url:'DataPage/getDatasBysite.jsp?&p=lossinfo&q=2@3@4&r=LossSite&s='+site,
				sortName: 'p0',
				sortOrder: 'desc',
				idField:'p0',
				frozenColumns:[[
	                {field:'p0',title:'旷课学员卡号',width:pw*0.3},
					{field:'p1',title:'旷课课程',width:pw*0.4},
					{field:'p2',title:'旷课日期',width:pw*0.3-80}
				]],
				pagination:true,
				rownumbers:true,
				singleSelect:true,
			...
			$('#test').datagrid({
				...
				nowrap: false,
				striped: true,
				url:'DataPage/getDatas.jsp?&p=lossinfo&p=1@2@3@4@5',
				sortName: 'p0',
				sortOrder: 'desc',
				idField:'p0',
				frozenColumns:[[
	                {field:'ck',checkbox:true},
	                {field:'p0',title:'旷课编号',width:pw*0.1},
	                {field:'p1',title:'旷课学员卡号',width:pw*0.2},
					{field:'p2',title:'旷课课程',width:pw*0.2},
					{field:'p3',title:'旷课日期',width:pw*0.3-80},
					{field:'p4',title:'旷课地点',width:pw*0.2}
				]],
				pagination:true,
				rownumbers:true,
				singleSelect:true,
			...
			$("#searchuser").click(function(){
				...
				if($('#cour').combobox('getValue') == ""){
					$.messager.alert('提示','旷课课程不能为空!','warning');return false;
				}
				//通过Ajax来读取要编辑的记录
...
<div id="form1" region="north" title="学员旷课" split="true"
...
<a class="easyui-linkbutton" id="adduser" icon="icon-add"
	href="javascript:void(0)">旷  课</a>
	<input type="hidden" name="tablename" value="lossinfo" />
	<input type="hidden" name="label" value="0" />
	<input type="hidden" name="returnpage" value = "StuCut.jsp" />
	<input type="hidden" name="fields" value="LossNo,LossCourse,LossData,LossSite" />
	<input type="hidden" name="postparams" value="cardnumber;cour;topicdate;site1" />
...
<form name="delrecord" method="post" action="FunctionPage/delRecord.jsp"
	...
	<input type="hidden" name="deltablename" value="lossinfo" />
	<input type="hidden" name="delreturnpage" value="StuCut.jsp" />
	</form>
</div>
