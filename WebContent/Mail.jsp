...
$(function(){
			...
			$('#test').datagrid({
				...
				nowrap: false,
				striped: true,
				url:'DataPage/getSearchDatas.jsp?&p=mailinfo&p=1@2@4@5&p=MailSendTo&p='+encodeURI(un),
				sortName: 'p0',
				sortOrder: 'desc',
				idField:'p0',
				frozenColumns:[[
					...
					{field:'p2',title:'发送人',width:pw*0.2},
				...
				toolbar:[{
					...
					handler:function(){
						...
						if (idstr == ""){
							$.messager.alert('提示','请选择您要删除的邮件!','warning');return false;
						}
...
<div id="w" class="easyui-window" minimizable="false" maximizable="false" collapsible="false" closed="true" title="新邮件"
	icon="icon-save"
	style="width: 720px; height: 280px; padding: 5px; background: #fafafa;">
...
<table border="1" width="98%">
	...
	<tr>
		<td>收件人:</td>
		<td colspan="3">
		<div style="width: 100%; color: blue; text-align: left;"><select
			id="mailsendto" name="mailsendto" class="easyui-combobox"
...
<a class="easyui-linkbutton" id="adduser" icon="icon-add"
	...
	name="tablename" value="mailinfo" /> <input type="hidden" name="label"
	value="0" /> <input type="hidden" name="returnpage" value="Mail.jsp" />
...
<form name="delrecord" method="post" action="FunctionPage/delRecord.jsp"
	...
	type="hidden" name="delreturnpage" value="Mail.jsp" /></form>
