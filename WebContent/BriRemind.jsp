...
$(function(){
			...
			$('#test').datagrid({
				...
				url:'DataPage/getBriDatasbySite.jsp?&p=stuinfo&q=1@2@3@13&r='+site,
				//url:'DataPage/getDatasBysite.jsp?&p=stuinfo&q=1@2@3@13&r=StuSite&s='+site,
				sortName: 'p0',
				sortOrder: 'desc',
				idField:'p0',
				frozenColumns:[[
	                {field:'ck',checkbox:true},
	                {field:'p0',title:'学员编号',width:pw*0.2},
					{field:'p1',title:'学员姓名',width:pw*0.3},
					{field:'p2',title:'学员手机号',width:pw*0.3-80},
					{field:'p3',title:'学员生日',width:pw*0.2}
				]],
				pagination:true,
				rownumbers:true,
				singleSelect:true,
			...
			$('#test').datagrid({
				...
				nowrap: false,
				striped: true,
				url:'DataPage/getBriDatas.jsp?&p=stuinfo&p=1@2@3@13@4',
				//url:'DataPage/getDatasBysite.jsp?&p=stuinfo&q=1@2@3@13&r=StuSite&s='+site,
				sortName: 'p0',
				sortOrder: 'desc',
				idField:'p0',
				frozenColumns:[[
	                {field:'ck',checkbox:true},
	                {field:'p0',title:'学员编号',width:pw*0.1},
					{field:'p1',title:'学员姓名',width:pw*0.2},
					{field:'p2',title:'学员手机号',width:pw*0.3-80},
					{field:'p3',title:'学员生日',width:pw*0.2},
					{field:'p4',title:'所属教学点',width:pw*0.2}
				]],
				pagination:true,
				rownumbers:true,
				singleSelect:true,
...
<div id="form1" region="north" title="生日短信发送" split="true"
...
<a class="easyui-linkbutton" id="adduser" icon="icon-save"
	...
	<input type="hidden" name="returnpage" value = "BriRemind.jsp" />
