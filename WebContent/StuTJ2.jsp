...
$(function(){
			...
			$('#test').datagrid({
				...
				nowrap: false,
				striped: true,
				url:'DataPage/getDatas.jsp?&p=costinfo&p=2@3@4@5@7@8',
				sortName: 'p0',
				sortOrder: 'desc',
				idField:'p0',
				frozenColumns:[[
	                {field:'ck',checkbox:true},
	                {field:'p0',title:'消费日期',width:pw*0.2},
					{field:'p1',title:'消费金额',width:pw*0.1},
					{field:'p2',title:'消费地点',width:pw*0.1},
					{field:'p3',title:'消费课程',width:pw*0.2},
					{field:'p4',title:'课程周期',width:pw*0.2},
					{field:'p5',title:'学员编号',width:pw*0.2}
				]],
				pagination:true,
				rownumbers:true,
				singleSelect:true,
...
<div id="form1" region="north" title="学员消费情况" split="true"
